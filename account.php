...
<div class="row">	
	<div class="col-md-12">
       <div class="typewriter">
        ...
        <h2 class="title_glow">MOJE KONTO</h2>
         </br>
      </div>
      </div>
	</div>
...
<button class="btn-primary btn-lg" type="submit" onclick="window.location.href='active_orders.php'">Moje zamówienia</button>
</br></br>
<button class="btn-primary btn-lg" type="submit" onclick="window.location.href='profil.php'">Profil</button>
</br></br>
</br></br>
<button class="btn-danger btn-lg " type="submit" onclick="window.location.href='login.php'">Wyloguj</button>
</br></br>

...
<div class="col-md-12">
						...
						<h2 class="title_glow">Discount prices</h2>
						</br>
						</div>
						</div>
</div>
...
$sql_promocje = $polaczenie->query("SELECT * FROM stock WHERE promocja=1");
...
echo<<<END
			...
			Cena:$price zł <button name="item" type="submit" class="btn-primary" id="$id" value="$id">Add</button>
